...
_PLASTIC_STARTUP_LABELS = (
    ...
    "premat_gpu_memory_buffer_gb:",                                                                                                                        # <<< THOG shared global buffer replaces fixed PLASTIC budget
...
def _print_plastic_depth_section(config: Any, trainer: Any) -> None:
    ...
    _print_plastic_option("premat_gpu_memory_buffer_gb:", _startup_float(config.premat_gpu_memory_buffer_gb))                                               # <<< THOG shared capacity reserve
