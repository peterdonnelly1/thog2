...
_ARGUMENT_TO_CONFIG = {
    ...
    "instrumentation__delta_loss_v_layer_heatmap__destination": "instrumentation__delta_loss_v_layer_heatmap__destination",
    ...
    # vvv THOG sampling-only chaos bump controls are material across resume and fork
    "chaos_bump__sampling__enabled": "chaos_bump__sampling__enabled",
    "chaos_bump__sampling__initial_lockout__steps": "chaos_bump__sampling__initial_lockout__steps",
    "chaos_bump__sampling__maximum_bumps": "chaos_bump__sampling__maximum_bumps",
    "chaos_bump__sampling__interlude__min_steps": "chaos_bump__sampling__interlude__min_steps",
    "chaos_bump__sampling__interlude__max_steps": "chaos_bump__sampling__interlude__max_steps",
    "chaos_bump__sampling__duration__min_steps": "chaos_bump__sampling__duration__min_steps",
    "chaos_bump__sampling__duration__max_steps": "chaos_bump__sampling__duration__max_steps",
    "chaos_bump__sampling__duration__max_fraction_of_elapsed_steps": "chaos_bump__sampling__duration__max_fraction_of_elapsed_steps",
    "chaos_bump__sampling__max_movement_fraction_of_local_gap": "chaos_bump__sampling__max_movement_fraction_of_local_gap",
    # ^^^ THOG
    ...
    *,
    ...
    return OwtRunConfig(
        ...
        **sheet_values,
        ...
        # vvv THOG reconstruct sampling-only chaos bump identity for legacy lifecycle recovery
        plastic__enabled=training_config.plastic__enabled,
        plastic__coarse_phase=training_config.plastic__coarse_phase,
        plastic__coarse_phase_roll_through=training_config.plastic__coarse_phase_roll_through,
        plastic__log_interval_coarse=training_config.plastic__log_interval_coarse,
        plastic__phase_1_n_steps=training_config.plastic__phase_1_n_steps,
        plastic__phase_1_starting_layer_count=training_config.plastic__phase_1_starting_layer_count,
        plastic__phase_1__number_of_trials=training_config.plastic__phase_1__number_of_trials,
        plastic__phase_1_evaluation_steps_count=training_config.plastic__phase_1_evaluation_steps_count,
        plastic__layers_to_sample=training_config.plastic__layers_to_sample,
        plastic__do_learn_layer_count=training_config.plastic__do_learn_layer_count,
        plastic__initial_layer_count=training_config.plastic__initial_layer_count,
        plastic__max_permitted_layers=training_config.plastic__max_permitted_layers,
        plastic__layer_sampling_initialisation=training_config.plastic__layer_sampling_initialisation,
        plastic__layer_count_objective=training_config.plastic__layer_count_objective,
        plastic__layer_count_update_brake=training_config.plastic__layer_count_update_brake,
        plastic__layer_count_probe__probe_every_n_steps=training_config.plastic__layer_count_probe__probe_every_n_steps,
        plastic__layer_count_probe__number_of_sampled_valid_tokens=training_config.plastic__layer_count_probe__number_of_sampled_valid_tokens,
        plastic__layer_count_probe_radius=training_config.plastic__layer_count_probe_radius,
        plastic__layer_count__max_allowable_layer_change=training_config.plastic__layer_count__max_allowable_layer_change,
        plastic__layer_count__adding_layers__discount_factor_for_extrapolation_evidence=training_config.plastic__layer_count__adding_layers__discount_factor_for_extrapolation_evidence,
        plastic__layer_count_probe__window_size_as_number_of_probes=training_config.plastic__layer_count_probe__window_size_as_number_of_probes,
        plastic__layer_count_probe_noise_lambda=training_config.plastic__layer_count_probe_noise_lambda,
        plastic__wall_time_equivalent_time_gain_discount=training_config.plastic__wall_time_equivalent_time_gain_discount,
        plastic__wall_time_equivalent_time_gain_loss_rate_window=training_config.plastic__wall_time_equivalent_time_gain_loss_rate_window,
        plastic__wall_time_equivalent_time_gain_loss_rate_min_observations=training_config.plastic__wall_time_equivalent_time_gain_loss_rate_min_observations,
        ...
        premat_diagnostic_layer_delay_ms=training_config.premat_diagnostic_layer_delay_ms,
        ...
        plastic__geometry_learning_rate_multiplier=training_config.plastic__geometry_learning_rate_multiplier,
        plastic__freeze_geometry_during_warmup=training_config.plastic__freeze_geometry_during_warmup,
        chaos_bump__sampling__enabled=training_config.chaos_bump__sampling__enabled,
        chaos_bump__sampling__initial_lockout__steps=training_config.chaos_bump__sampling__initial_lockout__steps,
        chaos_bump__sampling__maximum_bumps=training_config.chaos_bump__sampling__maximum_bumps,
        chaos_bump__sampling__interlude__min_steps=training_config.chaos_bump__sampling__interlude__min_steps,
        chaos_bump__sampling__interlude__max_steps=training_config.chaos_bump__sampling__interlude__max_steps,
        chaos_bump__sampling__duration__min_steps=training_config.chaos_bump__sampling__duration__min_steps,
        chaos_bump__sampling__duration__max_steps=training_config.chaos_bump__sampling__duration__max_steps,
        chaos_bump__sampling__duration__max_fraction_of_elapsed_steps=training_config.chaos_bump__sampling__duration__max_fraction_of_elapsed_steps,
        chaos_bump__sampling__max_movement_fraction_of_local_gap=training_config.chaos_bump__sampling__max_movement_fraction_of_local_gap,
        # ^^^ THOG
    ...
    if context["mode"] == "fresh":
        ...
        if training_config.plastic__enabled and training_config.plastic__coarse_phase == "enabled":
            ...
            coarse_fine_outcome = run_plastic_coarse_fine_lifecycle(
                ...
                memory_budget_gib=training_config.resolved_plastic_memory_budget_gib(),                                                                   # <<< THOG shared capacity-minus-global-buffer ceiling
