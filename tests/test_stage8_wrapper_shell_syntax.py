...
def test_stage8_current_wrappers_are_shell_syntax_valid() -> None:
    wrappers = [
        "current_scruffy_train_OWT.sh",
        "current_scruffy_inference_OWT.sh",
        "current_dreedle_train_OWT.sh",
        "current_dreedle_inference_OWT.sh",
        "scripts/current_scruffy_train_OWT.sh",
        "scripts/current_scruffy_inference_OWT.sh",
        "scripts/current_dreedle_inference_OWT.sh",
    ]
