...
def test_same_batch_visible_probe_number_resets_with_fresh_batch() -> None:
    ...
    try:
        ...
        assert first_plain.expandtabs(8).index("P1  probe_Δloss") == 359
        assert second_plain.expandtabs(8).index("P2  probe_Δloss") == 359
        assert third_plain.expandtabs(8).index("P1  probe_Δloss") == 359
