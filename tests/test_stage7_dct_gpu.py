...
class Stage7DctGpuTests(unittest.TestCase):
    ...
    def test_02_dct_full_block_gpu_bfloat16_tiny_train_step_records_dct_identity(self) -> None:
        ...
        config = stage4_training_config(geometry_preset=GEOMETRY_PRESET_BLOCK, basis_family=BASIS_FAMILY_DCT, device="cuda", dtype="bfloat16", max_updates=1, decay_updates=1)
