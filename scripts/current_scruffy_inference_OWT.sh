...
set -euo pipefail
cd "$(dirname "$0")/.."
CHECKPOINT=""; PROMPT="The meaning of life is"; DATA_DIR="${THOG2_OWT_DATA_DIR:-data/openwebtext}"; TOKENS=120; SAMPLES=1; TEMP=0.8; TOP_K=200; DTYPE=bfloat16; BACKEND=flash2; DEVICE=cuda; SEED=1337
