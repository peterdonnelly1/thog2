...
def compatibility_row(main_row: Mapping[str, Any], premat_row: Mapping[str, Any]) -> Dict[str, Any]:
    ...
    return {
        ...
        "sm_register_capacity": int(capacity["registers"]),
        "sm_shared_mem_bytes": int(capacity["shared"]),
        "sm_max_warps": int(capacity["warps"]),
        "sm_max_threads": int(capacity["threads"]),
        "sm_max_blocks": int(capacity["blocks"]),
