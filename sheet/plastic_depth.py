...
def plastic_depth_identity_metadata(
    *,
    ...
    layer_count_probe__window_size_as_number_of_probes: int,
    ...
    return {
        ...
        "plastic__layer_count__max_allowable_layer_change": int(layer_count_max_step),
        "plastic__layer_count__adding_layers__discount_factor_for_extrapolation_evidence": float(layer_count_extrapolation_weight),
        "plastic__wall_time_equivalent_time_gain_discount": float(wall_time_equivalent_time_gain_discount),
        "plastic__wall_time_equivalent_time_gain_loss_rate_window": int(wall_time_equivalent_time_gain_loss_rate_window),
        "plastic__wall_time_equivalent_time_gain_loss_rate_min_observations": int(wall_time_equivalent_time_gain_loss_rate_min_observations),
        ...
        "plastic__layer_count_probe__window_size_as_number_of_probes": int(layer_count_probe__window_size_as_number_of_probes),
        ...
        "plastic__layer_count__memory_budget_gib": layer_memory_budget_gib,
        "plastic__layer_count__cuda_allocator_reserve_gib": float(cuda_allocator_reserve_gib),
