...
class TrainingConfig:
    ...
    def __post_init__(self) -> None:
        ...
        if self.model_type == "dense":
            ...
            validate_dense_compact_fields(geometry_preset=self.geometry_preset, attention_geometry=self.attention_geometry, mlp_geometry=self.mlp_geometry, basis_family=self.basis_family)
        else:
