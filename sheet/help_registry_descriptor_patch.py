...
_DESCRIPTOR_SECTIONS: Tuple[DescriptorSection, ...] = (
    ...
    (
        ...
        (
            ...
            ("-I", "INSTRUMENTATION", "tensorboard | wandb | both | wandb_offline | none"),
    ...
    (
        ...
        (
            ...
            ("LPI", "--plastic__layer_count_probe_interval N", "updates between count probes"),
            ...
            ("LNW", "--plastic__layer_count_probe_noise_window N", "paired-score history window"),
            ("LNM", "--plastic__layer_count_probe_noise_min_observations N", "minimum evidence observations"),
            ("LNL", "--plastic__layer_count_probe_noise_lambda VALUE", "robust significance threshold"),
            ("LW", "--plastic__layer_count_cost_weight VALUE", "layer-cost penalty weight"),
            ("LMB", "--plastic__layer_memory_budget_gib VALUE", "memory_budget objective limit"),
            ("—", "--plastic__cuda_allocator_reserve_gib VALUE", "upward-probe free-memory reserve"),
