...
_DESCRIPTOR_SECTIONS: Tuple[DescriptorSection, ...] = (
    ...
    (
        ...
        (
            ...
            ("—", "--instrumentation__delta_loss_v_layer_heatmap log|linear", "W&B absolute-layer observational Δloss heatmap; absent means disabled"),
            ("—", "--instrumentation__delta_loss_v_layer_heatmap_linear MAX_STEP", "optional final optimizer step for linear per-probe uploads"),
            ("—", "--instrumentation__delta_loss_v_layer_heatmap_abs_limit VALUE", "fixed symmetric colour limit; default 0.05"),
            ("—", "--instrumentation__delta_loss_v_layer_heatmap_log_every_n_probes N", "W&B upload cadence; default 250 probes"),
