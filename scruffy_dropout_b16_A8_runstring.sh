...
# vvv THOG
# Scruffy high-microbatch layer-dropout comparison matching the Dreedle b16/A8 REVAMPV1 baseline shape.
export THOG2_HOST_LABEL="${THOG2_HOST_LABEL:-scruffy_dropout_b16_A8}"
